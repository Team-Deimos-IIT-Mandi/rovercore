...
WORLDS = {
    ...
    'moon2': {
        'world_name': 'moon2', 'x': '10.0', 'y': '10.0', 'yaw': '0.0',
...
def launch_setup(context, *args, **kwargs):
    ...
    elif world_arg == 'moon2':
        world_file = os.path.join(pkg_share, 'worlds', 'moon2.world.sdf')
    else:
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            'world',
            default_value='depot',
            choices=['depot', 'mars', 'moon2', 'mars_array', 'moon_array'],
            description=(
